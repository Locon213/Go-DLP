...
export const de: PartialTranslations = {
  ...
  themeStyle: 'Farbthema',
  darkModeDescription: 'Zum hellen Thema wechseln',
  lightModeDescription: 'Zum dunklen Thema wechseln',
  themeDefault: 'Standard Blau',
  themeOcean: 'Ozean',
  themeForest: 'Wald',
